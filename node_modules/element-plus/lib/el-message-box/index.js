...
var script = vue.defineComponent({
    ...
    props: {
        ...
        message: {
            type: [String, Object],
            validator: (val) => {
                return util.isString(val) || vue.isVNode(val);
            },
        },
        modalFade: {
            type: Boolean,
    ...
    setup(props, { emit }) {
        ...
        const icon = vue.computed(() => props.iconClass || (props.type && TypeMap[props.type] ? `el-icon-${TypeMap[props.type]}` : ''));
        const hasMessage = vue.computed(() => !!props.message);
        const inputRef = vue.ref(null);
        const confirmRef = vue.ref(null);
        const confirmButtonClasses = vue.computed(() => `el-button--primary ${props.confirmButtonClass}`);
        ...
        vue.watch(() => visible.value, val => {
            if (val) {
                if (props.type === 'alert' || props.type === 'confirm') {
                    vue.nextTick().then(() => { var _a, _b, _c; (_c = (_b = (_a = confirmRef.value) === null || _a === void 0 ? void 0 : _a.$el) === null || _b === void 0 ? void 0 : _b.focus) === null || _c === void 0 ? void 0 : _c.call(_b); });
                }
        ...
        const validate = () => {
            if (props.type === 'prompt') {
                ...
                if (inputPattern && !inputPattern.test(state.inputValue || '')) {
                    state.editorErrorMessage = props.inputErrorMessage || locale.t('el.messagebox.error');
...
const showMessage = (options) => {
    ...
    if (util.isVNode(options.message)) {
