...
function loadFsEvents() {
    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespaceDefaultOnly(require('fsevents')); })
        .then(namespace => {
...
function watch(configs) {
    ...
    loadFsEvents()
        .then(() => Promise.resolve().then(function () { return require('./watch.js'); }))
